/**
 * @file memlib.h
 * @brief Support functions for the memory emulation system
 *
 * This file exists to support the emulated mode of the memory allocator. Much
 * more extensive documentation exists in memlib.c.
 */
#ifndef MEMLIB_H__
#define MEMLIB_H__ 1
